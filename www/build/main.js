...
var NewHomePage = /** @class */ (function () {
        ...
        this.callBack = function (params) {
            return new Promise(function (resolve, reject) {
                if (params) {
                    ...
                    // }, () => { })
                    _this.scanId = params.id;
                    console.log(_this.scanId);
                    _this.httpClient.post(_this.base.BASE_URL + 'app/queryDeviceId', {}, { params: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpParams */]({ fromObject: { scanId: _this.scanId } }) })
    ...
    NewHomePage.prototype.scan = function () {
        console.log("scan");
        console.log(localStorage['username']);
        this.navCtl.push(__WEBPACK_IMPORTED_MODULE_5__scan_scan__["a" /* ScanPage */], { callBack: this.callBack });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__new_medicine_new_medicine__ = __webpack_require__(223);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__scan_scan__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_file_transfer__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__about_about__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__inject_query_inject_query__ = __webpack_require__(112);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DryPage = /** @class */ (function () {
    ...
    DryPage.prototype.test2 = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_file_transfer__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__about_about__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__enemy_query_enemy_query__ = __webpack_require__(113);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DeadtreePage = /** @class */ (function () {
    ...
    DeadtreePage.prototype.test2 = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (function (i) { return __awaiter(_this, void 0, void 0, function () {
                                var _this = this;
                                var element, j, obsernoPic;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            console.log("外层的i" + i);
                                            element = tmpStorage[i];
                                            if (!(element.hasPic == true)) return [3 /*break*/, 5];
                                            j = 1;
                                            _a.label = 1;
                                        case 1:
                                                                            ...
                                                                            return __generator(this, function (_a) {
                                                                                switch (_a.label) {
                                                                                    case 0:
                                                                                        ...
                                                                                        console.log(msg);
                                                                                        that.picNotExist = true;
                                                                                        if (!(this.j <= 1)) return [3 /*break*/, 2];
                                                                                        console.log("数据是", that.curOptions);
                                                                                        return [4 /*yield*/, that.httpClient.post(that.base.BASE_URL + 'app/AddDeadtreePhoto', {}, {
                                                                                                headers: { token: localStorage['token'] }, params: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!localStorage["TrackCache"]) return [3 /*break*/, 5];
                        loader_1 = this.loadingCtrl.create({
                            content: "缓存数据正在提交，请勿退出",
                        });
                        loader_1.present();
                        tmpStorage = JSON.parse(localStorage["TrackCache"]);
                        j = 0;
                        _a.label = 1;
                    case 1:
                                                                            ...
                                                                            return __generator(this, function (_a) {
                                                                                switch (_a.label) {
                                                                                    case 0:
                                                                                        ...
                                                                                        if (!(this.i <= 1)) return [3 /*break*/, 2];
                                                                                        console.log(that.currOptions);
                                                                                        return [4 /*yield*/, this.httpClient.post(this.base.BASE_URL + 'app/AddPhoto2', {}, {
                                                                                                headers: { token: localStorage['token'] }, params: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(j <= this.photosum)) return [3 /*break*/, 6];
                        return [4 /*yield*/, (function (j) { return __awaiter(_this, void 0, void 0, function () {
                                var _this = this;
                                var options, time, fileTransfer, uploadAddress, observer;
                                return __generator(this, function (_a) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__scan_scan__ = __webpack_require__(26);
